...
class Resume(models.Model):
    ...
    candidate_company = models.CharField(max_length=255, blank=True, null=True)
    candidate_role = models.CharField(max_length=255, blank=True, null=True)
